...
import { getActiveAssociate } from "../../utils/Handlerfunctions/getdata";
...
export default function OurAssociate() {
  ...
  const fetchData = async () => {
    try {
      const associateData = await getActiveAssociate();
  ...
  const handleEditClick = (item: OurAssociateItem) => {
    navigate(`/admin/ourassociates/edit/${item.id}`);
  };
  ...
  return (
    <div className="font-poppins text-gray-800 dark:text-white">
      {/* ✅ Heading */}
      <h3 className="text-lg font-semibold mb-5">Our Associates</h3>
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:bg-white/[0.03] px-4 pb-3 pt-4 sm:px-6">
        ...
        <div className="flex flex-wrap gap-2 justify-start sm:justify-end items-center mb-2">
          <Button
            ...
            onClick={() => navigate("/admin/ourassociates/add")}
          >
            + Add New Associate
          </Button>
          ...
          <Button
            ...
            onClick={() => navigate("/admin/inactive_associate")}
          >
            Show Inactive Associates
          </Button>
        </div>
