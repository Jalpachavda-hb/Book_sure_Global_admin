...
import { fetchcontactemail } from "../../../utils/Handlerfunctions/getdata";
import { updateEmailStatus } from "../../../utils/Handlerfunctions/formEditHandlers";
...
export default function Contactmail() {
  ...
  const fetchData = async () => {
    try {
      const emailData = await fetchcontactemail();
      setData(emailData || []);
    } catch (error) {
  ...
  const handleDelete = (id: number) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await updateEmailStatus(id, 0, fetchData);
  ...
  return (
    <div className="font-poppins text-gray-800 dark:text-white">
      <h3 className="text-lg font-semibold mb-5">Contact Emails</h3>
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:bg-white/[0.03] px-4 pb-3 pt-4 sm:px-6">
        ...
        <div className="flex justify-end mb-5">
          <Button
            ...
            onClick={() => navigate("/admin/contact_email/add")}
          >
