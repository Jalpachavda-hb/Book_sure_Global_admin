...
import { getActivePricingModel } from "../../utils/Handlerfunctions/getdata";
...
export default function PricingModelTable() {
  ...
  const fetchData = async () => {
    const pricingData = await getActivePricingModel();
    setData(pricingData);
  };
      ...
      <div className="overflow-hidden rounded-2xl border bg-white px-4 pb-3 pt-4 sm:px-6">
        ...
        <div className="flex gap-2 justify-end mb-4">
          <Button
            ...
            onClick={() => navigate("/admin/pricing-model/add")}
          >
            + Add Pricing Model
          </Button>
          ...
          <Button
            ...
            onClick={() => navigate("/admin/inactive_pricing_model")}
          >
